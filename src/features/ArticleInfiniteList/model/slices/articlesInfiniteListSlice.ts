...
import { fetchArticlesPageData } from '../services/fetchArticlesInfiniteListData/fetchArticlesInfiniteListData';
...
export const articlesInfiniteListSlice = createSlice({
    ...
    initialState: articlesAdapter.getInitialState<ArticleInfiniteListSchema>(initialState),
    reducers: {
